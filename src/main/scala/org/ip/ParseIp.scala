...
object ParseIp {
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark.sql("select stat_time,ap,ip,src_ip from udp limit 100")
    ...
    //      }
    //    }.toDF("stat_time", "ap", "ip", "src_ip")
    //    }.toDF("stat_time", "ap", "ip", "dst_country", "dst_region", "dst_city", "dst_isp", "src_ip", "src_country", "src_region", "src_city", "src_isp")
